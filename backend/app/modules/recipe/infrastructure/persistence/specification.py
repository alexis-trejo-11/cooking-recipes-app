...
from sqlalchemy import and_, not_, or_, func, String, Integer, DateTime
...
from app.modules.recipe.domain.models.entities.recipe import Recipe, DifficultyLevel
from app.modules.auth.domain.user import UserId
from app.modules.recipe.domain.models.value_objects.enums import MealType, DietType
...
class RecipeByMinRatingSpecification(Specification):
    ...
    def is_satisfied_by(self, candidate: Recipe) -> bool:
        ...
        if candidate.rating_count == 0:
            return False
        rating = candidate.rating_sum / candidate.rating_count
...
@dataclass
class RecipeByMaxCookingTimeSpecification(Specification):
