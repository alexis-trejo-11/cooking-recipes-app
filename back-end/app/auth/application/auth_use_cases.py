...
from app.auth.domain.interfaces import UserRepository, PasswordHasher, TokenService
from app.auth.domain.user import User, UserRole
from app.auth.domain.exceptions import UserCreationException
