...
class Recipe:
    ...
    def remove_ingredient(self, ingredient_id: IngredientId) -> None:
        ...
        self._check_not_deleted()
        self._collections = self._collections.remove_ingredient(ingredient_id)
        self._record_update()
    ...
    def reorder_steps(self, new_order: List[int]) -> None:
        """Reordenar pasos de la receta."""
        self._check_not_deleted()
        self._collections = self._collections.reorder_steps(new_order)
        self._record_update()
    ...
    def remove_tag(self, tag: Tag) -> None:
        """Remover etiqueta de la receta."""
        self._check_not_deleted()
        self._collections = self._collections.remove_tag(tag)
        self._record_update()
