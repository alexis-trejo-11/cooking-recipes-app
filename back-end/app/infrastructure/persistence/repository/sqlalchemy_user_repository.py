...
from app.domain.entities.value_objects import UserId
from app.infrastructure.persistence.models.models import UserModel
...
class SQLAlchemyUserRepository(UserRepository):
    ...
    def _to_entity(self, user_model: UserModel) -> User:
        ...
        # Reconstruct user from persisted data
