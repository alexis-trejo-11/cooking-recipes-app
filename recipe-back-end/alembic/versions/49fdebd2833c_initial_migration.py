...
Revision ID: 49fdebd2833c
Revises: 
Create Date: 2025-11-10 00:07:19.590912
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('favorite_count >= 0', name='check_favorite_count_non_negative'),
    ...
    sa.CheckConstraint('rating_sum >= 0', name='check_rating_sum_non_negative'),
    ...
    op.create_index('idx_recipes_rating', 'recipes', ['rating_count', 'rating_sum'], unique=False)
    ...
    op.create_index(op.f('ix_recipes_favorite_count'), 'recipes', ['favorite_count'], unique=False)
    op.create_index(op.f('ix_recipes_id'), 'recipes', ['id'], unique=False)
    op.create_index(op.f('ix_recipes_name'), 'recipes', ['name'], unique=False)
    op.create_index(op.f('ix_recipes_rating_sum'), 'recipes', ['rating_sum'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_recipes_rating_sum'), table_name='recipes')
    op.drop_index(op.f('ix_recipes_name'), table_name='recipes')
    op.drop_index(op.f('ix_recipes_id'), table_name='recipes')
    op.drop_index(op.f('ix_recipes_favorite_count'), table_name='recipes')
    ...
    op.drop_index('idx_recipes_rating', table_name='recipes')
