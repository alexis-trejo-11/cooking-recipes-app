#!/usr/bin/env python3
"""
Convert docs/project/source/*.md (YAML frontmatter + notes) into human-readable Markdown.

Usage:
    python docs/project/yaml_to_markdown.py
    python docs/project/yaml_to_markdown.py --input docs/project/source --output docs/project/generated
...
def write_index(output_dir: Path, generated: list[str]) -> None:
    lines = [
        "# Cooking Recipes API — Generated documentation",
        "",
