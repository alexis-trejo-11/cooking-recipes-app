...
from app.modules.recipe.infrastructure.persistence.models import recipe_reviews
from .base import BaseRepository

logger = logging.getLogger(__name__)


class SqlAlchemyRecipeReviewRepository(RecipeReviewRepository, BaseRepository):
    """
